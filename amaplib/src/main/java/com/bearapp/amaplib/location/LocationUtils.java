...
public class LocationUtils {
    ...
    public final static String ACTION_LOCATION = "ACTION.LOCATION";
    ...
    public static abstract class LocationReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(ACTION_LOCATION)) {
                AMapLocation location = intent.getParcelableExtra(KEY_LOCATION);
                onGetLocation(location);
            }
        }

        public abstract void onGetLocation(AMapLocation location);
    }

    public static IntentFilter getLocationIntentFilter() {
        return new IntentFilter(ACTION_LOCATION);
    }
}
